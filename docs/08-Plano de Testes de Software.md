...
| Passos  | 1) Acessar o Navegador <br>2) Informar o endereço do Site <br> 3) Visualizar a página principal <br>4) Clicar no ícone Meu Pedido <br> 5) Visualizar Itens do Carrinho <br> 6) Editar quantidade <br> 7) Remover Produto 8) Finalizar Pedido  |
